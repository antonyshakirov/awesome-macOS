...
- [Hop](https://hop.tools) - Eighteen everyday tools in one menu bar panel: timer, time tracker, keep-awake, system monitor, clipboard history, file converter, window layouts, screenshots with an editor, drawing over the screen, text recognition and more, with unused modules switched off. [![Open-Source Software][OSS Icon]](https://github.com/antonyshakirov/hop) ![Freeware][Freeware Icon]
